...
TOMORROW_DAILY_PROVINCIAL_PREDICTION = API_URL + "/prediccion/provincia/manana/{province}"
COMMUNITY_PREDICTION = API_URL + "/prediccion/ccaa/manana/{community}"
TODAY_COMMUNITY_PREDICTION = API_URL + "/prediccion/ccaa/manana/{community}/elaboracion/{date}"
